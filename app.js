        ...
        switch (message.postback.payload) {
          ...
          case "BUS":
            ...
            sendAttachmentMessage(
              senderId,
              "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0d/BINH_DUONG_Bus_Map.jpg/1024px-BINH_DUONG_Bus_Map.jpg",
              "image"
            );
            break;
          case "SP1":
            ...
            sendAttachmentMessage(
              senderId,
              "https://imagehost.imageupload.net/2020/05/18/ditichquocgia.png",
              "image"
            );
            break;
          case "SP2":
            ...
            sendAttachmentMessage(
              senderId,
              "https://imagehost.imageupload.net/2020/05/18/ditichcaptinh.png",
              "image"
            );
            break;
          case "DIEM":
          ...
          case "SP":
            ...
            sendAttachmentMessage(
              senderId,
              "https://gamek.mediacdn.vn/2019/2/12/photo-1-15499421010811780257743.png",
              "image"
            );
            break;
        }
...
function sendMessage(senderId, message) {
  request({
    ...
    qs: {
      access_token:
        "EAAD7RaVAYZAIBAP5FDle5shD6iBQrjgqarZCKduKX11q1Ng07gyKWZAwOjMwgh7UYJivu7uGHQA2wOk8gzSLFeVaPIelBVoY5AktBcXrUZB236AuGMKDANOqa4FF05KB9xZAR0BFX5NSeVCfMUlPyZBFdMtIJhWPOZBnf3kFpHA9IZCsjsaT22H1bhgQFHTKvF8ZD",
    },
    method: "POST",
    json: {
      recipient: {
